...
$("#delete").click(function() {
    ...
    modalvalid.setContent('Êtes-vous sur de vouloir suprimer le.s savoir être  ?');
        ...
        $.ajax({
           ...
           success: function (data) {
                if(data.SUCCES == "OK") {
                    ...
                    errormodal.setContent("Erreur le.s savoir être a des mini cv qui lui sont attaché.s");
                    errormodal.open();
                }
           }
       });
